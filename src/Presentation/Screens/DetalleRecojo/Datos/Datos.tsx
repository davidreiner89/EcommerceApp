...
interface DatosRecojoProps {
  envio: Envio;
  handleVerRuta: () => void;
}

export const Datos = ({envio, handleVerRuta}: DatosRecojoProps) => {
  // Configuramo la funcion para las llamadas
  const handleCall = () => {
    ...
    <>
      ...
      <Layout style={StylesDetEnvio.columnsContainer}>
        ...
        <Layout style={StylesDetEnvio.filaDos}>
          ...
          <Pressable onPress={handleVerRuta} style={StylesDetEnvio.buttonRutas}>
